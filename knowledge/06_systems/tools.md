...
| **CartScope** | Tech-facing step-by-step golf cart diagnostic checklist (web app) | Active — live https://cart-scope.vercel.app; code [NGC4160/CartScope](https://github.com/NGC4160/CartScope) — see [cartscope.md](cartscope.md) |
...
| **Brain catalog (generated)** | [`knowledge/.generated/drive_catalog.md`](../.generated/drive_catalog.md) — GENERATED, not policy. Names, ids, mime, modifiedTime, parent, view URL. |
| **Library catalog (redacted)** | [`knowledge/diagnostics/library_catalog.md`](../diagnostics/library_catalog.md) — QC-passed Drive manuals. No customer names. No HCP job numbers. |
...
| **Manuals / Evolution** | `1nGnADJf7gQVVippGkwoLTRPmNn0HfXXB` | [folder](https://drive.google.com/drive/folders/1nGnADJf7gQVVippGkwoLTRPmNn0HfXXB) |
