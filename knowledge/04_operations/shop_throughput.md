...
| Hayden Silva | Pickup/delivery (primary) — batch by zone, not one-off all day. Shop/tech assist only when transport allows; not an independent diagnostic tech. |
...
- Set Hayden’s pickup/delivery route (zone batched; free vs $99)
