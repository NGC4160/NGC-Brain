...
| [06_systems/tools.md](06_systems/tools.md) | Housecall Pro (pickup/drop-off queue + deposit job pipeline stages), QuickBooks, future DMS |
...
| [09_daily_ops/README.md](09_daily_ops/README.md) | **Daily operating guide** — rhythms, roles, **Chief routing**, **bot Slack to Jesse (Ryan yes first)**, data to feed AI |
...
**Chief** (Ryan's Grok Bot chief of staff) and shop bots must **operate from this brain** and **write durable facts back here**. Read `knowledge/` before acting. When a shop-running fact is confirmed (roster, policy, prices, workflow), update the matching file and [`09_daily_ops/decision_log.md`](09_daily_ops/decision_log.md) — do not leave it only in chat. **Chief routing:** Ryan talks to Chief only; check ownership before starting; always return results in Chief's thread — [daily ops](09_daily_ops/README.md#chief-routing). **Slack to Jesse Killian:** ask Ryan and wait for a yes — [daily ops](09_daily_ops/README.md#bot-slack-to-jesse).
