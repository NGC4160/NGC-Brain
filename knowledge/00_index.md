...
**Chief** (id `4bfa99c8-c29c-4149-a4ea-1a404d61f5a1`) is Ryan’s **only** Grok Bot point of contact. Ryan talks **ONLY** to Chief — he should never have to message another shop bot or hunt another chat. All other bots report to Chief. Approvals (Slack Jesse, money, payroll submit, sign-in, delete a bot, orders, **CartScope app changes**, **Shop Board app changes**, **SOP publish**, **loops merge**) go through Chief, who asks Ryan. Live roster: Inbox, Shop, Front Desk, Parts, Books, Betty (HR), CFO, Marketing, IT, Call Coach, Print (Blake), Bot Manager, **Diagnostics**, Bot Coach, CartScope Tester, Not My Tempo, SOP, Shop Board Tester, loops — [`05_team/roles.md`](05_team/roles.md).
