...
**Do not store** customer names, phones, addresses, or Housecall Pro job numbers.

**Do not invent** manuals, pinouts, or procedures. If a cart is not on this list, say so. How to search and add: [`service_manuals_sop.md`](service_manuals_sop.md).

## Drive folders

| Folder | Drive id | Open |
|--------|----------|------|
| **Manuals** (root) | `1-1QqJQh4UojQEERawwpfEjKYOor2VMuR` | [open](https://drive.google.com/drive/folders/1-1QqJQh4UojQEERawwpfEjKYOor2VMuR) |
| Club Car | `1xXeGwuymjre8YZt9QdMRgMYmGmLGCbAd` | [open](https://drive.google.com/drive/folders/1xXeGwuymjre8YZt9QdMRgMYmGmLGCbAd) |
| EZGO | `1sQXPs4-k6VaOb-yy_nZCF-APO9L4jALW` | [open](https://drive.google.com/drive/folders/1sQXPs4-k6VaOb-yy_nZCF-APO9L4jALW) |
| Yamaha | `1TcL_1FcplBuYYd6UEUwk3FvBqJZ5gk4z` | [open](https://drive.google.com/drive/folders/1TcL_1FcplBuYYd6UEUwk3FvBqJZ5gk4z) |
...
This catalog lists **only** the manuals below. Other PDFs may exist in Drive Manuals; they are **not** catalogued here.
...
**HDK DEL3022G Operation and Maintenance Manual.pdf** — [view](https://drive.google.com/file/d/1zNYcdPmZsc4kGvpdIWwXDAhMNQEKnJdM/view) (`1zNYcdPmZsc4kGvpdIWwXDAhMNQEKnJdM`)

- Folder: Manuals/Evolution
- Pages: 51
- Source: Archive.org manualzilla-id-6016637
- QC: PASS as O&M / mid-depth service-level (Curtis 1243/1268 era); not Big-3 dealer SM
- Wiring diagrams: weak/absent in OCR
- Electrical TS tables: YES

**Curtis Model 1268 Controller Manual.pdf** — [view](https://drive.google.com/file/d/1oBXBSYMDDVqNDaOaWkUqRXTlyS2xDgIg/view) (`1oBXBSYMDDVqNDaOaWkUqRXTlyS2xDgIg`)
...
**2020_Service_Manual_TRACKER_EViS_72V_10002660-B.pdf** (Tracker EViS 2020 SM 10002660-B) — [view](https://drive.google.com/file/d/1E1CRawt8S3FFpkLEezD-38i1tqdU8z3l/view) (`1E1CRawt8S3FFpkLEezD-38i1tqdU8z3l`)

- Folder: Manuals/Tracker
- Pages: 154
- Source: already on Drive
- Wiring: YES
- Fault testing: YES
- QC: PASS full SM

**2021 Tracker EViS Repair and Service Manual 10002660-C.pdf** (Tracker EViS 2021 SM 10002660-C) — [view](https://drive.google.com/file/d/1qZB3_B3yjBDYM1jxALJ2VvbHcKTgT1jT/view) (`1qZB3_B3yjBDYM1jxALJ2VvbHcKTgT1jT`)

- Folder: Manuals/Tracker
- Pages: 154
- Source: new on Drive 2026-09-16
- Wiring: YES
- Fault testing: YES
- QC: PASS full SM
...
- Search / approve / add SOP: [`service_manuals_sop.md`](service_manuals_sop.md)
- Diagnostics library rules: [`README.md`](README.md)
- Generated Drive name/id listing (not this QC catalog): [`../.generated/drive_catalog.md`](../.generated/drive_catalog.md)
