...
OEM pinouts and procedures: Drive Manuals (EZGO / Club Car / Yamaha / Other / Evolution / Tracker / Tomberlin), the redacted [`../library_catalog.md`](../library_catalog.md), and the **NGC Manuals board** — see [`../README.md`](../README.md).
