...
DOCUMENTS: list[dict] = [
    # --- Hiring ---
    {
        ...
        "description": "15–20 min scored phone screen — transferable skills, safety gate, Advance/Maybe/Pass",
    ...
    {
        "id": "tech-shop-eval-quiz",
        "category": "hiring",
        "title": "Technician written hiring quiz (Drive)",
        "description": "Written 120 / hands-on 120 / diagnostics 60 point sheets — pair with hands-on scorecard",
        "type": "link",
        "href": "https://drive.google.com/",
        "audience": "Ryan",
        "status": "planned",
        "featured": False,
        "notes": "Source: My Drive/Hiring quiz evaluation - Technician.docx — link when shared URL available",
    },
    # --- Team & HR ---
    {
