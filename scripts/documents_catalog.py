...
DOCUMENTS: list[dict] = [
    ...
    },
    {
        ...
        "type": "markdown",
        "audience": "Ryan / Christine",
        "status": "active",
        "featured": True,
    },
    {
        "id": "admin-job-description-pdf",
        "category": "hiring",
        "title": "Admin job description (PDF)",
        "description": "Printable PDF — internal JD, Indeed posting, screening questions",
        "source": "external_docs/templates/hiring/NGC_Admin_Job_Description.pdf",
        "type": "pdf",
        "audience": "Ryan / Christine",
        "status": "active",
        "featured": True,
    ...
    {
        "id": "admin-job-description-html",
        "category": "hiring",
        "title": "Admin job description (HTML)",
        "description": "Printable HTML source for the JD PDF — Print / Save PDF",
        "source": "external_docs/templates/hiring/NGC_Admin_Job_Description.html",
        "deploy_name": "admin-job-description.html",
        "type": "html",
        "audience": "Ryan / Christine",
        "status": "active",
        "featured": False,
    ...
    },
    {
        ...
        "description": "Christine-ready lithium quote script/template — planned",
        "type": "markdown",
        "audience": "Christine",
        "status": "planned",
        "featured": False,
...
def build_catalog() -> dict:
    ...
    catalog = {
        ...
        "title": "NGC Documents",
        "description": "Structured forms, scorecards, and working documents for Ryan & Christine",
        "how_to_add": (
