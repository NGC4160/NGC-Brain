...
- **Intake: cart size and gate access (Ryan, 2026-09-25):** Every intake call asks whether the cart is a standard 4-seater or extended (6-seater or stretch). Record the size on the HCP job right away for trailer space, even before photos. If the size is unknown, record `Size unknown, scheduled as extended` and schedule it as extended until photos confirm. Ask whether the cart is in a gated community: get the gate code, or ask to be added to the guest list for pickup day. Record the gate code, guest-list name, or `No gate` in the job notes before the trip is scheduled. Never invent a size. Published procedure: **Administrative Operations SOP - Section 5 Customer Intake and Scheduling, Revision 1** (effective 2026-09-26) in Drive Procedures (doc id `1B6JeWgBnpjxDQ4ATF5DfrcCd-B4km28Zst0VyDNS6xE`).
...
| **Administrative Operations SOP - Section 5 Customer Intake and Scheduling, Revision 1** (effective 2026-09-26) | [Drive file](https://drive.google.com/file/d/1B6JeWgBnpjxDQ4ATF5DfrcCd-B4km28Zst0VyDNS6xE/view) (doc id `1B6JeWgBnpjxDQ4ATF5DfrcCd-B4km28Zst0VyDNS6xE`) in Drive [Procedures](https://drive.google.com/drive/folders/1-NjzSQxTsbXqlOhbK7ptZzg1H5G2ntdh). Intake: cart size and gate access — see section 1 above. |
