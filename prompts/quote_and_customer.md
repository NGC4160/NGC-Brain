...
Copy and fill in the bracketed parts:

---

**Help me with a customer situation.**

Read `knowledge/02_products/lithium_conversions.md`, `knowledge/02_products/lithium_sales_guide.md`, `knowledge/07_customers_marketing/customer_reply_standard.md`, `knowledge/03_services/shop_services.md`, and the pricebook CSV if needed.

**Situation:** [new quote / follow-up / complaint / warranty question / pickup question]

**Cart:** [make, model, voltage if known, lead-acid vs lithium now]
...
2. Deposit amount if applicable
...
```
Quote a [36V/48V/MINI/72V/150AH] Professional lithium conversion for a [brand/model] in [city].
Cart notes: [lights/horn/radio/USB? how is 12V fed? factory charge port? street vs course].
Follow the office sales guide: all three packages on the estimate; lead with Essential; default talk to Ready-to-Run; Accessory-Ready only if needed.
Include deposit, warranty, pickup policy. No invented package prices. Kit list = battery, charger, monitor only.
Mention turnaround only if they asked. Do not send the sales guide to the customer.
```
